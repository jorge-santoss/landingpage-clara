  ...
  return (
    <footer className={styles.footer}>
      <div className={styles.container}>
        ...
        <div className={styles.topRow}>
          ...
          <div className={styles.brandCol}>
            <Image
              ...
              alt="L'Atelier de Clara Logo"
              width={140}
              height={90}
              style={{ width: "auto", height: "auto" }}
            />
            <h3 className={styles.brandTitle}>L’atelier de clara</h3>
            <p className={styles.address}>123 Bd Republique, Cannes</p>
          </div>
          ...
          <nav className={styles.legalCol}>
            <ul>
              ...
              <li><Link href="/droits-auteur">Droits d’auteur</Link></li>
            </ul>
          </nav>
        ...
        {/* Grand Titre en Bas - Écris ton texte exactement comme tu le souhaites entre les guillemets */}
        <div className={styles.bigTitleWrapper}>
          <h2 className={styles.bigTitle}>{"L’atelier de clara"}</h2>
        </div>
        ...
        <div className={styles.socialBarWrapper}>
          <div className={styles.socialBar}>
            ...
            <div className={styles.socialIcons}>
              ...
              <a href="#" aria-label="Instagram" className={styles.iconBox}>
              ...
              <a href="#" aria-label="Facebook" className={styles.iconBox}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M9 8H6v4h3v12h5V12h3.642L18 8h-4V6.333C14 5.374 14.5 5 15.5 5H18V0h-3.808C10.592 0 9 1.583 9 4.615V8z"/>
                </svg>
              </a>

              <a href="#" aria-label="TikTok" className={styles.iconBox}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
